...
--
--createPaymentTable
CREATE TABLE IF NOT EXISTS entity.payment (code VARCHAR(8), instalment INTEGER, payment_date DATE,
...
--insertPayment
INSERT INTO entity.payment (code, instalment, payment_date, description, expense_item, expense_currency,
